      ...
      <main className="pt-20 md:pt-24">
        <div className="section-container section-padding">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground space-y-10">
            ...
            <section>
              <h2 className="font-display text-xl font-semibold text-foreground mb-4">Siège social et contact</h2>
              <p>
            ...
            <section>
              <h2 className="font-display text-xl font-semibold text-foreground mb-4">Directeur de la publication</h2>
            ...
            <section>
              <h2 className="font-display text-xl font-semibold text-foreground mb-4">Données personnelles</h2>
            ...
            <section>
              <h2 className="font-display text-xl font-semibold text-foreground mb-4">Responsabilité</h2>
            ...
            <section>
              <h2 className="font-display text-xl font-semibold text-foreground mb-4">Durée de conservation</h2>
            ...
            <p className="text-sm text-muted-foreground">Paris, le 22 juillet 2025</p>
          </div>
        </div>
      </main>
      <Footer />
